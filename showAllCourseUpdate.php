...
<body>
 ...
 <center> DETAILS COURSE WITHIN ONE SEMESTER </center>
    <table id="t01" bordercolor="#000000"  align="center">
     <tr bgcolor="#9C640C" >
    <th width="10%" bordercolor="#000000">WEEK</th>
    ...
    <th width="10%">DELETE</th>
	  ...
	  $nextLimit = $id1 + 13;
	   $sqlone2 = "SELECT
     DISTINCT day1, title1,update1,stuID,CourseNo,week,date_start,date_end
FROM
     course
WHERE CourseNo BETWEEN '$id1' and '$nextLimit'
ORDER BY week";
  ...
  <tr bgcolor="#ECBE22" bordercolor="#000000">
   ...
   <td><?php echo $papar2['date_start']; ?></td>
    ...
    <td align="center"><a href="updateCourse.php?CourseNo=<?php echo $papar2['CourseNo'] ;?>"><i><img src="img_kemaskini.png"></i></a>
...
?>
    		...
    		<tr>
					<td colspan="2" align="center"><div align="center" ><a href="showSemua.php">
