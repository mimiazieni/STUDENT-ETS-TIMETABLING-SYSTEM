...
<body>
    ...
    <th width="20%">TIME OUT</th>
	  ...
	  $id1=$_GET['CourseNo'];
	   $sqlone2 = "SELECT
     DISTINCT day1, title1,update1,stuID, SUBSTRING(date_start,1,10) as dateOnly,SUBSTRING(date_start,11,17) as timeOnly,SUBSTRING(date_end,11,17)as date_end,CourseNo
FROM
     course
WHERE CourseNo ='$id1'
ORDER BY 
  ...
  <tr bgcolor="#ECBE22" bordercolor="#000000">
    ...
    <td><select name="date_start">
     ...
     <td><select name="date_end" >
     	 <option value="<?php echo $papar2['dateOnly'];echo $papar2['date_end'];?> "><?php echo $papar2['date_end']; ?> </option>
         <option value="<?php echo $papar2['dateOnly'];?> 08:00:00">08:00:00</option>
         <option value="<?php echo $papar2['dateOnly'];?> 09:00:00">09:00:00</option>
         <option value="<?php echo $papar2['dateOnly'];?> 10:00:00">10:00:00</option>
         <option value="<?php echo $papar2['dateOnly'];?> 11:00:00">11:00:00</option>
 ...
 <?php 
	...
	if(isset($_POST["submit2"]))
	{
		...
		$sql1="UPDATE course SET day1='$day1' WHERE CourseNo = '$id1'";
		...
		else
		{
			...
			<center>
				<script language="javascript"> 
					alert("Successfully update!");window.location="showSemua.php";
  	    		</script>
			</center><?php
		}
		
		$sql2="UPDATE course SET title1 ='$title1' WHERE CourseNo = '$id1'";
