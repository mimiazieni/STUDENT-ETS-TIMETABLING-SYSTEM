   ...
   <?php
		...
		if($page==""||$page=="1")
			...
			$page1=($page*25)-25;
      		...
      		$sqlone3 = "SELECT * FROM etsschedule WHERE station = 'TAPAH ROAD'";//the query for get all data in customer
...
$res1=mysql_query("SELECT * FROM etsschedule WHERE station = 'TAPAH ROAD'");
